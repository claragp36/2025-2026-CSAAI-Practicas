...
const jugadorImg = new Image(); jugadorImg.src = "nave.jpg";
const enemigoImg = new Image(); enemigoImg.src = "alien.jpeg";
...
function update(timestamp) {
    ...
    if (vivos.length === 0) finalizarJuego("MISION COMPLETADA!", true);
